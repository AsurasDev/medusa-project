...
var _default = function _default(rootDirectory) {
  ...
  app.use("/wishlists/:token", (0, _cors["default"])(corsOptions));
  app.get("/wishlists/:token", (0, _cors["default"])(corsOptions), _express["default"].json(), /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
      var customerService, token, decode, customer, wishlist;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            decode = _jsonwebtoken["default"].decode(token, JWT_SECRET);
            if (!(!decode || !decode.customer_id)) {
              _context.next = 6;
              break;
            }
            throw new _medusaCoreUtils.MedusaError(_medusaCoreUtils.MedusaError.Types.NOT_FOUND, "Invalid token");
          case 6:
            _context.next = 11;
            break;
          case 8:
          ...
          case 11:
            _context.prev = 11;
            _context.next = 14;
            return customerService.retrieve(decode.customer_id);
          case 14:
