...
var _default = function _default() {
  ...
  app["delete"]("/:id/wishlist", _bodyParser["default"].json(), /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
      var customerService, customer, wishlist, newWishlist;
  ...
  app.post("/:id/wishlist", _bodyParser["default"].json(), /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
      var lineItemService, customerService, regionService, customer, regions, lineItem, wishlist;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _context2.next = 12;
            return lineItemService.generate(req.body.variant_id, regions[0].id, req.body.quantity, {
          ...
          case 12:
            ...
            return customerService.update(customer.id, {
              metadata: {
                wishlist: [].concat(_toConsumableArray(wishlist), [lineItem])
              }
            });
          case 16:
            customer = _context2.sent;
  ...
  app.post("/:id/wishlist/share-token", _bodyParser["default"].json(), /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
      var _customer$metadata;
      var customerService, customer, token;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (customer !== null && customer !== void 0 && (_customer$metadata = customer.metadata) !== null && _customer$metadata !== void 0 && _customer$metadata.wishlist) {
              _context3.next = 6;
              break;
            }
            throw new _medusaCoreUtils.MedusaError(_medusaCoreUtils.MedusaError.Types.INVALID_DATA, "Invalid data - Customer doesn't have a wishlist");
          case 6:
